...
C_Tone = pygame.mixer.Sound('sounds/C.mp3')
D_Tone = pygame.mixer.Sound('sounds/D.mp3')
E_Tone = pygame.mixer.Sound('sounds/E.mp3')
F_Tone = pygame.mixer.Sound('sounds/F.mp3')
G_Tone = pygame.mixer.Sound('sounds/G.mp3')
A_Tone = pygame.mixer.Sound('sounds/A.mp3')
B_Tone = pygame.mixer.Sound('sounds/B.mp3')
